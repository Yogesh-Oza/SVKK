/** Age-band keys on policy-member MIS rows (must stay in sync with report queries). */
...
export type PolicyMemberAgeBuckets = Record<PolicyMemberAgeBucketKey, number | bigint>;
