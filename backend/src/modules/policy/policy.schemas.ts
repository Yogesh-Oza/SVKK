...
const adPolicyExtraSchema = z.object({
  ...
  loanRepaymentAmount: z.number().nonnegative().nullish().optional(),
  loanPendingAmount: z.number().nonnegative().nullish().optional(),
  nomineeDateOfBirth: z.coerce.date().nullish().optional(),
  policyBankHolderName: z.string().max(200).optional().nullable(),
  policyBankAccountNo: z.string().max(34).optional().nullable(),
  policyBankIfsc: z.string().max(20).optional().nullable(),
  policyBankBranch: z.string().max(200).optional().nullable(),
  policyBankName: z.string().max(200).optional().nullable(),
