...
export const claimUpdateBodySchema = z.object({
  ...
  mdId: optionalText(100),
  categoryText: optionalText(100),
  status: z.nativeEnum(ClaimStatus).optional(),
  statusText: optionalText(200),
  claimType: optionalText(100),
  actualLodgeType: optionalText(100),
  treatmentType: optionalText(100),
  treatmentProcedure: optionalText(300),
  diseaseCategory: optionalText(200),
  claimAmount: optionalAmount,
  reportedLodgeAmount: optionalAmount,
  ...
  paymentInFavourOf: optionalText(200),
  paymentDate: optionalDate,
  prsCrsDate: optionalDate,
});
