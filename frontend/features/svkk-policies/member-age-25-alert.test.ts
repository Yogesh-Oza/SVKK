...
describe("carry forward turning 25 alert", () => {
  ...
  it("parses form DD-MM-YYYY dates (not US MM-DD) so carry-forward alert can fire", () => {
    // 01-06-2001 = 1 June 2001. A broken parser would read this as 6 Jan and miss age 24→25.
    const names = membersTurning25OnCarryForward(
      [member({ name: "Ravi", dob: "01-06-2001", gender: "M" })],
      "01-06-2025",
      "01-06-2026",
    );
    expect(names).toEqual(["Ravi"]);
